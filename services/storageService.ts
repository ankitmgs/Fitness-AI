 ...
 */
const apiRequest = async (method: 'GET' | 'POST' | 'PUT', endpoint: string, token: string, body?: any) => {
...
class StorageService {
  ...
  async addWeightLog(token: string, log: WeightLog): Promise<WeightLog> {
  ...
  async saveWaterLog(token: string, log: WaterLog): Promise<WaterLog> {
