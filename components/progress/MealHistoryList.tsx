                ...
                <div key={meal.id} className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
                  <div className="flex justify-between items-center">
                      <div className="flex-1 mr-4">
                          <p className="font-semibold text-gray-800 dark:text-gray-200 truncate" title={meal.name}>{meal.name}</p>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          >
                              {deletingMealId === meal.id ? <Spinner className="h-5 w-5" /> : <TrashIcon />}
                          </button>
                        </div>
                      </div>
                  </div>
